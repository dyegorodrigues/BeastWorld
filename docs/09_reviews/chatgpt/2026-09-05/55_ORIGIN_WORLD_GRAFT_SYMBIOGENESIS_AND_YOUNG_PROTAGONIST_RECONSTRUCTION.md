...
```mermaid
flowchart TD
    A["Original Beast World"] --> B["Predatory invasion and defeat"]
    B --> C["Sacrifice and refugee world-core"]
    C --> D["Graft into a human world"]
    D --> E["Composite ecology and accessible Quintessence"]
    E --> F["Human–Beast coevolution"]
    F --> G["Founding compacts, Dynasties and Academy"]
    G --> H["The old predator finds the refuge"]
```
