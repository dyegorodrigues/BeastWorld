...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `BW-SESSION-2026-08-22-001` | 2026-08-22 | Autor + Manus | arquivar interações, fontes, respostas e novo delta do universo | captura + governança | `manus/reconstruction-spine-2026-08-21` | `c4bc567` | `ef17817f05b8b5d75c8ab6859a592ad4a0687280` | `RAW-AVAILABLE` para anexos; `RAW-PARTIAL` para histórico de chat | `SYNCED / AUDITED-PARTIAL` | histórico anterior não possui transcript contínuo verificável; pacote local `audit/` permanece como cópia de trabalho não rastreada, mas seu conteúdo foi copiado para o pacote Manus | ler `INTERACTION_ARCHIVE_INDEX.md`; usar `RETOMADA.md` e abrir o Documento-Mestre ou Source Record alvo |
