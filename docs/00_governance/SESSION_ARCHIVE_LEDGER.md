...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `BW-SESSION-2026-08-22-001` | 2026-08-22 | Autor + Manus | arquivar interações, fontes, respostas e novo delta do universo | captura + governança | `manus/reconstruction-spine-2026-08-21` | a confirmar no fechamento | a confirmar no fechamento | `RAW-AVAILABLE` para anexos; `RAW-PARTIAL` para histórico de chat | `CAPTURED / AUDITED-PARTIAL` | histórico anterior não possui transcript contínuo verificável | ler `INTERACTION_ARCHIVE_INDEX.md`; versionar manifest e delta criativo |
